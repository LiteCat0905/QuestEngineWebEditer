        ...
        <n-card title="" size="huge" class="left">
            ...
            <n-space @change="load" vertical>
                ...
                <n-space justify="center">
                    <n-checkbox v-model:checked="formValue.quest.accept.auto" size="large" />
                ...
                <n-space justify="center">
                    <n-checkbox v-model:checked="formValue.quest.time.reset" size="large" />
                    <n-tag type="info" size="medium">
                ...
                <n-space justify="center">
                    <n-checkbox v-model:checked="formValue.quest.mode.shareData" size="large" />
                    <n-tag type="info" size="medium">
                    ...
                    <template #default="{ value }">
                        <n-space vertical>
                            ...
                            <n-input v-model:value="value.node" type="textarea" placeholder="NODE" :autosize="{
                                minRows: 3
                            }" v-if="!Istask(value.event)" />
                            <template v-if="Istask(value.event)">
                                <n-input v-model:value="value.event"><template #prefix>
                                        Task命名
                                    </template></n-input>
                                <n-input v-model:value="value.period" :allow-input="onlyAllowNumber"><template #prefix>
                                        多久检测一次(tick,20tick=1s)
                                    </template></n-input>
                                <n-space justify="center">
                                    <n-checkbox v-model:checked="value.async" size="large" />
                                    <n-tag type="info" size="medium">
                                        是否异步<template #icon>
                                            <n-icon>
                                                <CaretLeft24Regular />
                                ...
                                <n-input v-model:value="value.condition" type="textarea" placeholder="Kether布尔值语句"
                                    :autosize="{
                                        minRows: 3
                                    }" />
                            </template>
                            ...
                            <n-dynamic-input v-model:value="value.trigger" :on-create="Trigger_Create">
                                ...
                                <template #default="{ index }">
                                    <n-space vertical>
                                        ...
                                        <n-input v-model:value="value.trigger[index].script" type="textarea"
                                            placeholder="达成条件脚本" :autosize="{
                                                minRows: 3
                                            }" />
                                        <n-tag type="info" :bordered="false">————这是一条超酷的分割线————</n-tag>
                                    </n-space>
